...
String detailsToJson(Anime data) => json.encode(data.toJson());
...
class Anime {
  ...
  factory Anime.fromJson(Map<String, dynamic> json) => new Anime(
        ...
        // openingThemes:
        //     new List<String>.from(json["opening_themes"].map((x) => x)),
        // endingThemes:
        //     new List<String>.from(json["ending_themes"].map((x) => x)),
      );
